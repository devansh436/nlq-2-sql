  ...
  if (!result) {
    return (
      <Fade in timeout={800}>
        ...
        >
          <StorageIcon sx={{ fontSize: 64, color: 'primary.main', opacity: 0.3, mb: 2 }} />
    ...
    return (
      <Fade in timeout={500}>
        ...
        >
          ...
          >
            <Typography variant="h6" sx={{ mb: 1 }}>Query Failed</Typography>
                  ...
                  {results.map((row, index) => (
                    ...
                    >
                      {Object.values(row).map((value, cellIndex) => (
                        ...
                        >
                          {value === null ? (
                            <em style={{ color: '#94a3b8', fontStyle: 'italic' }}>NULL</em>
                          ) : (
                            value.toString()
                          )}
                        </TableCell>
